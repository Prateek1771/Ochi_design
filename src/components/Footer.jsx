...
function Footer() {
  return (
    <div className="w-full h-screen p-20 flex gap-5">
        <div className="w-1/2 h-full flex flex-col justify-between font-neue">
            <div className="headding">
                <h1 className="text-8xl uppercase leaning-none ">Eye-</h1>
                <h1 className="text-8xl uppercase leaning-none ">Opening</h1>
            </div>
        ...
        <div className="w-1/2 font-neue">
            <div className="headding">
                <h1 className="text-8xl uppercase leaning-none ">Presentations</h1>
                <div className="parts flex">
                <div className="part1 w-1/2">
                    <div className="dets1 font-inter">
                        <div className="pb-4 pt-4">S:</div>
                        <a href="#">Behance</a><br />
                        <a href="#">Instagram</a><br />
                        <a href="#">Facebook</a><br />
                        <a href="#">Linkedin</a><br />
                    </div>
                    <div className="dets2 font-inter">
                        <div className="pb-4 pt-4">L:</div>
                        <a href="#">202-1965 W 4th Ave</a><br />
                        <a href="#">Vancouver, Canada</a><br />
                    </div>
                    <div className="dets3 font-inter">
                        <div className="pb-4 pt-4">E:</div>
                        <a href="#">hello@ochi.design</a><br />
                    </div>
                </div>

                <div className="part2 w-1/2">
                <div className="dets4 font-inter">
                    <div className="pb-4 pt-4">S:</div>
                    <a href="#">Home</a><br />
                    <a href="#">Service</a><br />
                    <a href="#">Our work</a><br />
                    <a href="#">About Us</a><br />
                    <a href="#">Insights</a><br />
